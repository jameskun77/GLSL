...
int main(int argc, char* argv[])
{
	...
	Shader shader(FileSystem::getPath("resources/shader/step3_cubeTexture/cubemaps.vs").c_str(),
		FileSystem::getPath("resources/shader/step3_cubeTexture/cubemaps.fs").c_str());

	Shader skyShader(FileSystem::getPath("resources/shader/step3_cubeTexture/skybox.vs").c_str(),
		FileSystem::getPath("resources/shader/step3_cubeTexture/skybox.fs").c_str());
